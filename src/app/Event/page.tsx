            ...
            <div className='flex flex-row justify-center gap-8'>
              ...
              <div className='gap-2 flex flex-col'>
                <div className='flex flex-col leading-tight'>
                  ...
                  <h1 className='text-xl font-bold tracking-tighter'>#{registration.referenceId}</h1>
                </div>

                <div className='flex flex-col leading-tight'>
                  <span className='text-zinc-500 font-medium tracking-tighter text-xs'>Event Name</span>
                  <h2 className='text-sm font-semibold tracking-tighter text-white'>{registration.eventName}</h2>
                </div>

                <div className='flex flex-col leading-tight'>
                  <span className='text-zinc-500 font-medium tracking-tighter text-xs'>Event Time</span>
                  <h2 className='text-sm font-semibold tracking-tighter text-white'>{registration.eventTime}</h2>
                </div>

                <div className='flex flex-col leading-tight'>
                  <span className='text-zinc-500 font-medium tracking-tighter text-xs'>Team Name</span>
                  <h2 className='text-sm font-semibold tracking-tighter text-white'>{registration.teamName}</h2>
                </div>
              </div>
            </div>
          </div>
